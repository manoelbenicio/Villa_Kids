...
| 010 | 2026-05-17T21:23:00Z | — | GEMINI-UX | Phase 3 | Home Page assembly: build the 8-section conversion-optimized home (Hero, Sobre, Pilares, Ambientes, Galeria, Depoimentos, FAQ, CTA Final). Picks up H-005. | IN_PROGRESS | Replacing Phase 2 smoke-test index.astro with the premium Phase 3 home + generating SVG placeholder assets. |
...
| 011 | 2026-05-18T00:26:30Z | — | CODEX-OPS | Phase 7+8 | Deploy scripts and independent operations docs | IN_PROGRESS | ADR-003 read; preparing HostGator SSH/rsync scripts and docs |
